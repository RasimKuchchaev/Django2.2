...
SECRET_KEY = 'django-insecure-y8e$87+)jpqu53bd-vu(&kc*$a%l0!06qoqfl7eudz4+v-zd4+'
...
CACHES = {
    'default': {
        'BACKEND': 'django.core.cache.backends.locmem.LocMemCache'          # Для кеширования в оперативку
    }
}
